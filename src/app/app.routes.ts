...
export const routes: Routes = [
  ...
  {
    path: 'subir-publicacion-agujeros-negros',
    component: SubirPublicacionAgujerosNegrosComponent,
  },
  {
    path: 'subir-publicacion-galaxias',
    component: SubirPublicacionGalaxiasComponent,
  },
  {
    path: 'subir-publicacion-planetas-y-estrellas',
    component: SubirPublicacionPlanetasYEstrellasComponent,
  },
  {
    path: 'subir-publicacion-satelites',
    component: SubirPublicacionSatelitesComponent,
  },
  {
    path: 'subir-publicacion-teorias',
    component: SubirPublicacionTeoriasComponent,
  },
  {
    path: 'subir-publicacion-universos',
    component: SubirPublicacionUniversosComponent,
  },
  {
    path: 'subir-publicacion-vida-extraterrestre',
    component: SubirPublicacionVidaExtraterrestreComponent,
  },
